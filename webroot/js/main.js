...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $("#form").on('submit', function (e) {
            ...
            $.post(post_url, post_data, function (data) {
                ...
                if (data.response.type == 'error') {
                    renderError(data.response.errors);
                } else {
                    output = '<div class="notification success"><span class="notification-icon"><i class="fa fa-check" aria-hidden="true"></i></span><span class="notification-text">' + data.response.text + '</span></div>';
        ...
        function renderError(errors){
            ...
            for(var i in errors){
                $("#" + i + "-error").remove();
                error_html = '<em id="' + i + '-error" class="error help-block">'+errors[i]+'</em>';
                $("input[name=" + i + "]").after(error_html);
            }
        }
