function initialize() {
    var markers = [];
    var map = new google.maps.Map(document.getElementById('map-canvas-location'), {
    ...
    function displayPosition(pos) {
        ...
        var url = "http://maps.googleapis.com/maps/api/geocode/json?latlng=" + pos.lat() + "," + pos.lng() + "&sensor=false";
        $.ajax({url: url,
